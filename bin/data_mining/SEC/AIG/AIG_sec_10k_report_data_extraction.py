...
if __name__ == '__main__':
    ...
    # TEST CASES
    # sec_report_2003_sections = [['columns', 10905, 11971]] 
    ...
    # sec_report_2003_sections = [['columns', 526, 1425], ['columns', 1575, 2289], ['columns', 3125, 4585], ['columns', 4706, 6171], ['columns', 6234, 6492], ['rows', 8454, 9007], ['columns', 10905, 11971]]
